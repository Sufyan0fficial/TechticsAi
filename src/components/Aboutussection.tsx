...
function Aboutussection({
  ...
  return (
    <div>
      <div className="md:bg-gradient-to-r from-[#0056F8] to-[#45E7FF] bg-gradient-to-b rounded-3xl  px-10 xl:py-32 lg:py-24 pt-16  pb-40 w-full flex  lg:relative md:w-[80%] lg:w-full ">
